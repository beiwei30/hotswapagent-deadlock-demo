...
public class App {
    ...
    private static void test() throws ClassNotFoundException {
        CustomClassLoader classLoader = new CustomClassLoader(getUrls(App.class.getClassLoader()));
        Class c = classLoader.loadClass("com.fasterxml.jackson.databind.ObjectMapper");
